/*!
  Highlight.js v11.8.0 (git: 7fb52a23ea)
...
scope:"title",begin:f,relevance:0},UNDERSCORE_TITLE_MODE:{scope:"title",begin:E,
relevance:0},METHOD_GUARD:{begin:"\\.\\s*"+E,relevance:0},
END_SAME_AS_BEGIN:e=>Object.assign(e,{"on:begin":(e,n)=>{n.data._beginMatch=e[1]
},"on:end":(e,n)=>{n.data._beginMatch!==e[1]&&n.ignoreMatch()}})})
;function T(e,n){"."===e.input[e.index-1]&&n.ignoreMatch()}function R(e,n){
...
const c=Object.create(null);function l(){if(!x.keywords)return void S.addText(A)
...
strings:o,keywords:u}}},grmr_csharp:e=>{const n={
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},m]}},grmr_cpp:e=>{
...
},m=[b,l,s,t,e.C_BLOCK_COMMENT_MODE,c,o],p={variants:[{begin:/=/,end:/;/},{
begin:/\(/,end:/\)/},{beginKeywords:"new throw return else",end:/;/}],
...
contains:[t,e.C_BLOCK_COMMENT_MODE,o,c,s,{begin:/\(/,end:/\)/,keywords:u,
...
relevance:0}],illegal:[/[;<']/,/BEGIN/]}},grmr_xml:e=>{
...
begin:/\(/,end:/\)/,keywords:m,contains:[E,r,f,e.C_BLOCK_COMMENT_MODE,l,d,_]
},N={relevance:0,
...
},o=[e.BACKSLASH_ESCAPE,i,s],c=[/!/,/\//,/\|/,/\?/,/'/,/"/,/#/],l=(e,a,i="\\1")=>{
...
contains:g}},grmr_plaintext:e=>({name:"Plain text",aliases:["text","txt"],
...
className:"meta",begin:/^[\t ]*@/,end:/(?=#)|$/,contains:[u,m,c]}]}},grmr_r:e=>{
...
},n.FUNCTION_DISPATCH]}},grmr_sql:e=>{
...
relevance:0}]}},grmr_shell:e=>({name:"Shell Session",
...
className:"keyword",
match:m(...Ae.filter((e=>"string"!=typeof e)).concat(Se).map(ke),...Me)}]},c={
$pattern:m(/\b\w+/,/#\w+/),keyword:s.concat(Re),literal:Ce},l=[i,r,o],g=[{
...
},S,...l,...g,...p,f,O,...C,...T,R,I]}},grmr_ini:e=>{const n=e.regex,t={
...
name:"TypeScript",aliases:["ts","tsx","mts","cts"]}),n},grmr_yaml:e=>{
...
aliases:["yml"],contains:c}},grmr_properties:e=>{
const n="[ \\t\\f]*",t=n+"[:=]"+n,a="[ \\t\\f]+",i="([^\\\\:= \\t\\f\\n]|\\\\.)+",r={
end:"("+t+"|"+a+")",relevance:0,starts:{className:"string",end:/$/,relevance:0,
contains:[{begin:"\\\\\\\\"},{begin:"\\\\\\n"}]}};return{name:".properties",
disableAutodetect:!0,case_insensitive:!0,illegal:/\S/,
contains:[e.COMMENT("^\\s*[!#]","$"),{returnBegin:!0,variants:[{begin:i+t},{
begin:i+a}],contains:[{className:"attr",begin:i,endsParent:!0}],starts:r},{
className:"attr",begin:i+n+"$"}]}},grmr_nginx:e=>{const n=e.regex,t={
className:"variable",variants:[{begin:/\$\d+/},{begin:/\$\{\w+\}/},{
begin:n.concat(/[$@]/,e.UNDERSCORE_IDENT_RE)}]},a={endsWithParent:!0,keywords:{
...
illegal:"[^\\s\\}\\{]"}}});const He=ae;for(const e of Object.keys(Ke)){
