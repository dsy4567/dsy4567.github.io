...
export default (() => {
	if (location.hostname !== "dsy4567.eu.org" && location.hostname !== "dsy4567.github.io") return;
	const /** @type {HTMLScriptElement} */ s1 = document.createElement("script"),
		ga_id = location.hostname === "dsy4567.eu.org" ? "G-060YCRMSSH" : "G-N7WR0PVV4J";
	...
	if (location.hostname !== "dsy4567.eu.org") return;
